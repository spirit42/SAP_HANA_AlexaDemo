sap.ui.define([
		...
		return BaseObject.extend("fsm.dev.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias fsm.dev.model.ListSelector
			 */
			 ...
			 * @return {fsm.dev.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
